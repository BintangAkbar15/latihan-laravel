            ...
            <div class="flex items-center">
              ...
              <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                  ...
                  <x-nav-list href="/" :active="request()->is('/')">Home</x-nav-list>
                  <x-nav-list href="/blog" :active="request()->is('blog')">Blog</x-nav-list>
                  <x-nav-list href="/about" :active="request()->is('about')">About</x-nav-list>
                  <x-nav-list href="/contact" :active="request()->is('contact')">Home</x-nav-list>
                </div>
              </div>
            </div>
            <div class="hidden md:block">
